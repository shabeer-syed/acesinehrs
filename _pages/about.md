...
header:
  ...
  cta_url: 
  caption:
excerpt: 'Adverse childhood experiences (ACEs) are potentially traumatic, neglectful or violent experiences in childhood. By incorporating information about ACEs, healthcare providers can gain a holistic understanding of their patients' backgrounds and tailor treatment plans accordingly. At a population level, EHRs can be used by healthcare organisations to identify at-risk groups, implement preventive measures, and allocate resources efficiently by analysing trends, patterns, and outcomes across patient populations. Clinically, EHRs can support streamlining workflows, assisting decision-making, and enhancing patient care. <br /> <small><a 
