...
header:
  ...
  cta_url: 
  caption:
excerpt: 'Adverse childhood experiences (ACEs) are potentially traumatic, neglectful or violent experiences in childhood which can have profound impact on children and families lives and long-term health<br /> <small><a href="" > Incoperating information on ACEs into electronic health records (EHRs) can help healthcare organisations identify at-risk groups, implement preventive measures, and allocate resources efficiently by analysing trends, patterns, and outcomes across patient populations. Clinically, indicators of ACEs in EHRs can support streamlining workflows, assisting decision-making, and enhancing patient care. </a></small><br /><br /> {::nomarkdown}<iframe style="display: inline-block;" src=" " frameborder="0" scrolling="0" width="160px" height="30px"></iframe> <iframe style="display: inline-block;" src="" frameborder="0" scrolling="0" width="158px" height="30px"></iframe>{:/nomarkdown}'
