...
header:
  ...
  cta_url: 
  caption:
excerpt: 'Adverse childhood experiences (ACEs) are potentially traumatic, neglectful or violent experiences in childhood <br /> <small><a href="https://www.thelancet.com/journals/lanpub/article/PIIS2468-2667(23)00119-6/fulltext"> At a population level, EHRs can be used by healthcare organisations to identify at-risk groups, implement preventive measures, and allocate resources efficiently by analysing trends, patterns, and outcomes across patient populations. Clinically, EHRs can support streamlining workflows, assisting decision-making, and enhancing patient care. </a></small><br /><br /> {::nomarkdown}<iframe style="display: inline-block;" src=" " frameborder="0" scrolling="0" width="160px" height="30px"></iframe> <iframe style="display: inline-block;" src="" frameborder="0" scrolling="0" width="158px" height="30px"></iframe>{:/nomarkdown}'
