  ...
  <header class="relative bg-slate-800 bg-opacity-70 text-white" style="background-image: url('https://raw.githubusercontent.com/shabeer-syed/acesinehrs/master/images/ACEsinEHRs%20home%20page%202023.jpg'); background-size: cover; background-position: center; background-blend-mode: multiply;">
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-24 text-center md:text-left">
      <h1 class="hero-title drop-shadow-lg">
        ACEs Code List <span style="color: #bfdbfe !important;">Browser</span>
      </h1>
      <p class="hero-subtitle drop-shadow-md mx-auto md:mx-0">
        Search, filter, and access clinical code lists seamlessly cross-mapped across multiple healthcare coding systems.
      </p>
    </div>
  </header>
  ...
  <main class="flex-grow py-12 md:py-16">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 md:p-6 mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div class="flex-1">
          ...
          <div class="flex flex-wrap gap-2.5">
            <!-- CM -->
            <div class="inline-flex items-center px-3 py-1.5 rounded-md bg-rose-50 border border-rose-100 text-rose-800 text-sm font-medium">
              <span class="bg-rose-500 text-white px-2 py-0.5 rounded text-xs font-bold mr-2">CM</span> Child Maltreatment
            </div>
            <!-- IPV -->
            <div class="inline-flex items-center px-3 py-1.5 rounded-md bg-fuchsia-50 border border-fuchsia-100 text-fuchsia-800 text-sm font-medium">
              <span class="bg-fuchsia-500 text-white px-2 py-0.5 rounded text-xs font-bold mr-2">IPV</span> Intimate Partner Violence
            </div>
            <!-- HRP-CM -->
            <div class="inline-flex items-center px-3 py-1.5 rounded-md bg-purple-50 border border-purple-100 text-purple-800 text-sm font-medium">
              <span class="bg-purple-600 text-white px-2 py-0.5 rounded text-xs font-bold mr-2">HRP-CM</span> High-Risk Presentation of CM
            </div>
            <!-- SM -->
            <div class="inline-flex items-center px-3 py-1.5 rounded-md bg-emerald-50 border border-emerald-100 text-emerald-800 text-sm font-medium">
              <span class="bg-emerald-500 text-white px-2 py-0.5 rounded text-xs font-bold mr-2">SM</span> Parental Substance Misuse
            </div>
            <!-- AFE -->
            <div class="inline-flex items-center px-3 py-1.5 rounded-md bg-blue-50 border border-blue-100 text-blue-800 text-sm font-medium">
              <span class="bg-blue-600 text-white px-2 py-0.5 rounded text-xs font-bold mr-2">AFE</span> Adverse Family Environments
            </div>
            <!-- MHPs -->
            <div class="inline-flex items-center px-3 py-1.5 rounded-md bg-cyan-50 border border-cyan-100 text-cyan-800 text-sm font-medium">
              <span class="bg-cyan-500 text-white px-2 py-0.5 rounded text-xs font-bold mr-2">MHPs</span> Parental Mental Health Problems
            </div>
          </div>
        </div>
      ...
      <div class="flourish-container-wrap">
        <div class="flourish-embed flourish-table" data-src="visualisation/7018703">
